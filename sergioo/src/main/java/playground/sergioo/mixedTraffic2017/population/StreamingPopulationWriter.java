package playground.sergioo.mixedTraffic2017.population;
...
public final class StreamingPopulationWriter implements PersonAlgorithm {
    private final static Logger log = Logger.getLogger(org.matsim.core.population.io.StreamingPopulationWriter.class);
