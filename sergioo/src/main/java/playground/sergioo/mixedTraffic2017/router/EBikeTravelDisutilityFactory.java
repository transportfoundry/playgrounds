...
package playground.sergioo.mixedTraffic2017.router;
...
public class EBikeTravelDisutilityFactory implements TravelDisutilityFactory {
	private static final Logger log = Logger.getLogger( org.matsim.core.router.costcalculators.RandomizingTimeDistanceTravelDisutilityFactory.class ) ;
	...
	public EBikeTravelDisutilityFactory(PlanCalcScoreConfigGroup cnScoringGroup ) {
		this.mode = "ebike";
	...
	public TravelDisutility createTravelDisutility(
		...
		return new EBikeTravelDisutility(
				travelTime,
	...
	public EBikeTravelDisutilityFactory setSigma(double val ) {
		this.sigma = val ;
		return this;
	}
}
