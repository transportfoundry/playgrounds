...
public class Network2SHP {

	public static void main(String[] args) throws Exception {

		Config config = ConfigUtils.createConfig();
		config.network().setInputFile("C:/Users/beckerh/SiouxFalls/network.xml");
		...
		ShapeFileWriter.writeGeometries(features, "C:/Users/beckerh/SiouxFalls/shp/network_links.shp");
		...
		ShapeFileWriter.writeGeometries(features, "C:/Users/beckerh/SiouxFalls/shp/network_nodes.shp");
	}
